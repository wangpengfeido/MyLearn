...
Vue.component('component-two', function () {
    // 工厂函数也可以返回一个Promise
...
// 异步组件工厂函数也可以是如下格式的对象
Vue.component('component-four', function () {
  return {
    ...
    component: new Promise(function (resolve, reject) {
      ...
      setTimeout(function () {
        resolve({
          template: `<div>this is component four</div>`,
        });
      }, 3000);
    }),
    // // 加载时显示的组件
...
let app = new Vue({
  components: {
    // 组件内注册也可以异步加载
    'component-three': function (resolve, reject) {
      setTimeout(function () {
        resolve({
