...
@NgModule({
  ...
  declarations: [AaaDisplayingDataComponent, AbaTemplateSyntaxComponent, AbaAaaComponent, AbaAbaComponent, AbaAcaComponent, AcaLifecycleHookComponent, AbaAcaAaaComponent, AdaComponentCommunicationComponent, AbaAdaAaaComponent, AbaAdaAbaComponent, AbaAdaAcaComponent, AeaComponentStyleComponent, AbaAeaAaaComponent, AbaAeaAbaComponent, AbaAeaAcaComponent, AfaDynamicComponentComponent, AgaAttributeDirectiveComponent, AbaAgaAaaDirective, AbaAfaInsertOneComponent, AbaAfaInsertTwoComponent, AbaAfaHostDirective, AbaAfaDynamicComponentComponent, AhaStructuralDirectivesComponent, AbaAhaAaaDirective],
